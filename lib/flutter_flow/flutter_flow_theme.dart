...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1C8BC2);
  late Color secondary = const Color(0xFF88171D);
  late Color tertiary = const Color(0xFF083850);
  late Color alternate = const Color(0xFFF25750);
  late Color primaryText = const Color(0xFF244B5F);
  late Color secondaryText = const Color(0xFF333A3F);
  late Color primaryBackground = const Color(0xFFDBE2E7);
  late Color secondaryBackground = const Color(0xFF999C9F);
  late Color accent1 = const Color(0xFF616161);
  late Color accent2 = const Color(0xFF757575);
  late Color accent3 = const Color(0xFFE0E0E0);
  late Color accent4 = const Color(0xFFEEEEEE);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xFF06131A);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFF1B3F88);

  late Color customColor1 = Color(0xFFFFFFFF);
  late Color grayLight = Color(0xFF95A1AC);
  late Color grayLighter = Color(0xFFFFFFFF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF62B0D8);
  late Color secondary = const Color(0xFFD23437);
  late Color tertiary = const Color(0xFF314F5E);
  late Color alternate = const Color(0xFFC7403A);
  late Color primaryText = const Color(0xFFF7EFEE);
  late Color secondaryText = const Color(0xFFD0746F);
  late Color primaryBackground = const Color(0xFF0A1B26);
  late Color secondaryBackground = const Color(0xFF06131A);
  late Color accent1 = const Color(0xFFEEEEEE);
  late Color accent2 = const Color(0xFFE0E0E0);
  late Color accent3 = const Color(0xFF757575);
  late Color accent4 = const Color(0xFF616161);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xFFC7403A);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFF1C4494);

  late Color customColor1 = Color(0xFF06131A);
  late Color grayLight = Color(0xFF95A1AC);
  late Color grayLighter = Color(0xFF06131A);
