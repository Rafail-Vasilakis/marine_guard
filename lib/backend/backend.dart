...
import 'schema/vessel_record.dart';
...
export 'schema/vessel_record.dart';
...
/// Functions to query VesselRecords (as a Stream and as a Future).
Future<int> queryVesselRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VesselRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VesselRecord>> queryVesselRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VesselRecord.collection,
      VesselRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VesselRecord>> queryVesselRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
